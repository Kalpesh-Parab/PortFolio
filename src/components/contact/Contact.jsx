...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_fg5fipr', 'template_ldyzlvf', formRef.current, {
        publicKey: 'p0l2c3jCDmlEOfhSE',
      })
      .then(
        () => {
          console.log('SUCCESS!');
    ...
    >
      <motion.div className='textContainer' variants={variants}>
        ...
        <motion.div variants={variants} className='item'>
          <h2>Mail</h2>
          <span>kalpeshparab1099@gmail.com</span>
        </motion.div>
        <motion.div variants={variants} className='item'>
          <h2>Address</h2>
          <span>Wadgaonsheri, Pune, Maharashtra.</span>
        </motion.div>
        <motion.div variants={variants} className='item'>
          <h2>Phone</h2>
          <span>+91 8446257619</span>
        </motion.div>
      </motion.div>
